...
def run():
    ...
    for test in itertools.product(DN_THREADS, MN_THREADS, tmp_coros, KVEXE):
        ...
        comm = f'--zipf=0.99 --qp_type=1 --c_thread={COROS[test[2]][0]}  --dn_thread={test[0]} --mn_thread={test[0]} --read={readp}'
        ...
        #     i_list = [i]
            ...
            #     j_list = [i]
                ...
                for k in KVEXE:
                    ...
                    for test in itertools.product(DN_THREADS, MN_THREADS,  tmp_coros, k_list):
                        if test in res:
                            if res[test] is None:
                                print("error")
                                print(test)
                    ...
                    print(*x_line, *y_line, *DN_THREADS, *y2_line, *y3_line)
