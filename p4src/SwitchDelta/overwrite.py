...
from p4_pd_rpc import overwrite
...
try:
    ...
    protocol = TMultiplexedProtocol(protocol, "overwrite")
    client = overwrite.Client(protocol)
    ...
    #     0,
    #     devtt,
    #     overwrite_cache_check_match_spec_t(int(kEnumWriteReplyWithData))
    # )
    # client.cache_check_table_add_with_cache_read_reply(
    #     0,
    #     devtt,
    #     overwrite_cache_check_match_spec_t(int(kEnumReadReply))
    # )
    # client.cache_check_table_add_with_cache_write_req(
    #     0, 
    #     devtt,
    #     overwrite_cache_check_match_spec_t(int(kEnumWriteAndRead))
    # )
    # client.cache_check_table_add_with_cache_read_req(
    #     0,
    #     devtt,
    #     overwrite_cache_check_match_spec_t(int(kEnumReadReq))
    # )

    client.timecheck_table_add_with_timecmp(
        0,
        devtt,
        overwrite_timecheck_match_spec_t(int(kEnumAppendReply))
    )

    client.timecheck_table_add_with_timecmp(
        0,
        devtt,
        overwrite_timecheck_match_spec_t(int(kEnumUpdateIndexReq))
    )

    client.timecheck_table_add_with_timeclr(
        0,
        devtt,
        overwrite_timecheck_match_spec_t(int(ReplySwitch))
    )
    ...
    client.visibility_table_add_with_new_index(
        0, 
        devtt, 
        overwrite_visibility_match_spec_t(int(kEnumAppendReply)))
    client.visibility_table_add_with_new_index(
        0, 
        devtt, 
        overwrite_visibility_match_spec_t(int(kEnumUpdateIndexReq)))

    # client.visibility_table_add_with_delete_index(
    #     0, 
    #     devtt, 
    #     overwrite_visibility_match_spec_t(kEnumUpdateIndexReply))
    client.visibility_table_add_with_delete_index(
        0, 
        devtt, 
        overwrite_visibility_match_spec_t(int(ReplySwitch)))
        # overwrite_udp_route_match_spec_t
    
    client.visibility_table_add_with_check_index(
        0, 
        devtt, 
        overwrite_visibility_match_spec_t(int(kEnumReadIndexReq)))
    ...
    client.key2logid0_table_add_with_read_log_id0(
        0, 
        devtt, 
        overwrite_key2logid0_match_spec_t(int(kEnumReadIndexReq)))
    
    client.key2logid0_table_add_with_write_log_id0(
        0, 
        devtt, 
        overwrite_key2logid0_match_spec_t(int(kEnumAppendReply)))
    client.key2logid0_table_add_with_write_log_id0(
        0, 
        devtt, 
        overwrite_key2logid0_match_spec_t(int(kEnumUpdateIndexReq)))
    
    client.key2logid1_table_add_with_read_log_id1(
        0, 
        devtt, 
        overwrite_key2logid1_match_spec_t(int(kEnumReadIndexReq)))
    
    client.key2logid1_table_add_with_write_log_id1(
        0, 
        devtt, 
        overwrite_key2logid1_match_spec_t(int(kEnumAppendReply)))
    client.key2logid1_table_add_with_write_log_id1(
        0, 
        devtt, 
        overwrite_key2logid1_match_spec_t(int(kEnumUpdateIndexReq)))
    ...
    client.fix_port_table_add_with_send_to_index(
        0, 
        devtt, 
        overwrite_fix_port_match_spec_t(188, int(kEnumMultiCastPkt)))
    
    client.fix_port_table_add_with_send_to_client(
        0, 
        devtt, 
        overwrite_fix_port_match_spec_t(136, int(kEnumMultiCastPkt)))
    client.fix_port_table_add_with_send_to_client(
        0, 
        devtt, 
        overwrite_fix_port_match_spec_t(136, int(kEnumReadIndexReq)))
    client.fix_port_table_add_with_send_to_client(
        0, 
        devtt, 
        overwrite_fix_port_match_spec_t(180, int(kEnumMultiCastPkt)))
    client.fix_port_table_add_with_send_to_client(
        0, 
        devtt, 
        overwrite_fix_port_match_spec_t(180, int(kEnumReadIndexReq)))
    client.fix_port_table_add_with_send_to_client(
        0, 
        devtt, 
        overwrite_fix_port_match_spec_t(172, int(kEnumMultiCastPkt)))
    client.fix_port_table_add_with_send_to_client(
        0, 
        devtt, 
        overwrite_fix_port_match_spec_t(172, int(kEnumReadIndexReq)))
    ...
    for i in port_list:
        ...
        client.counter_table_table_add_with_counter_add(
            0,
            devtt,
            overwrite_counter_table_match_spec_t(int(kEnumAppendReq), port),
            overwrite_counter_add_action_spec_t(i)
        )  
        # client.counter_table_table_add_with_counter_add(
        #     0,
        #     devtt,
        #     overwrite_counter_table_match_spec_t(int(kEnumUpdateIndexReq), port),
        #     overwrite_counter_add_action_spec_t(i)
        # )     
        client.counter_table_table_add_with_counter_sub(
            0,
            devtt,
            overwrite_counter_table_match_spec_t(int(ReplySwitch), port),
            overwrite_counter_sub_action_spec_t(i)
        )
        client.counter_table_table_add_with_counter_sub(
            0,
            devtt,
            overwrite_counter_table_match_spec_t(int(kEnumUpdateIndexReply), port),
            overwrite_counter_sub_action_spec_t(i)
        )
        ...
        client.counter_table_table_add_with_counter_read(
            0,
            devtt,
            overwrite_counter_table_match_spec_t(int(kEnumAppendReply), port),
            overwrite_counter_sub_action_spec_t(i)
        )
        client.counter_table_table_add_with_counter_read(
            0,
            devtt,
            overwrite_counter_table_match_spec_t(int(kEnumReadReply), port),
            overwrite_counter_sub_action_spec_t(i)
        )
        client.counter_table_table_add_with_counter_read(
            0,
            devtt,
            overwrite_counter_table_match_spec_t(int(kEnumReadIndexReply), port),
            overwrite_counter_sub_action_spec_t(i)
        )
        client.counter_table_table_add_with_counter_read(
            0,
            devtt,
            overwrite_counter_table_match_spec_t(int(kEnumReadSend), port),
            overwrite_counter_sub_action_spec_t(i)
        )
    ...
    while line:
        ...
        client.ipv4_route_table_add_with_set_egr(0, devtt,
                                                 overwrite_ipv4_route_match_spec_t(
                                                     ip2int(ip)),
                                                 overwrite_set_egr_action_spec_t(int(port)))
        # egress
        
        client.ethernet_set_mac_table_add_with_ethernet_set_mac_act(0, devtt,
                                                                    overwrite_ethernet_set_mac_match_spec_t(
                                                                        int(port)),
                                                                    overwrite_ethernet_set_mac_act_action_spec_t(mac2v(mac)))
        # do ucast
        print client.udp_route_table_add_with_set_port_action(
            0, devtt, overwrite_udp_route_match_spec_t(int(node)), overwrite_set_port_action_action_spec_t(int(port)))
        line = f.readline()
